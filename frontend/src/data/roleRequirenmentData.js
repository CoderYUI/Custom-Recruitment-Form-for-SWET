...
• Contribute fresh ideas to elevate design strategy.`,
    fields: [
      ...
      { label: 'Specialization Area:', name: 'graphicDesignerSpecialization', type: 'text', placeholder: 'e.g., Branding, UI/UX, Print Design', required: true },
    ],
  },
  'FRONT OFFICE': {
    title: 'FRONT OFFICE',
...
• Maintain logs, records, and daily attendance tracking.`,
    fields: [
      ...
      { label: 'Communication Skills:', name: 'frontOfficeCommunicationSkills', type: 'text', placeholder: 'e.g., Excellent, Good, Basic', required: true },
    ],
  },
  'RESEARCH': {
    title: 'RESEARCH',
...
• Collaborate with other teams for successful implementation.`,
    fields: [
      ...
      { label: 'Data Analysis Tools:', name: 'researchDataAnalysisTools', type: 'text', placeholder: 'e.g., Excel, SPSS, R, Python', required: true },
    ...
    fields: [
      {
        ...
        name: 'technicalProgrammingLanguages',
        type: 'textarea',
      ...
      },
      {
        ...
        name: 'technicalGithubPortfolio',
        type: 'url',
        placeholder: 'Link to your GitHub profile or technical portfolio.',
        required: true,
      },
      {
        label: 'Problem-Solving Experience:',
        name: 'technicalProblemSolvingExperience',
        type: 'textarea',
        placeholder: 'Describe a complex technical problem you solved.',
        required: true,
      },
    ],
  },
...
• Ensure compliance with labor laws and regulations.`,
    fields: [
      ...
      { label: 'HR Software Knowledge:', name: 'hrSoftwareKnowledge', type: 'text', placeholder: 'e.g., HRIS, ATS (Applicant Tracking System)', required: true },
...
• Content can represent diverse voices, fostering an inclusive environment`,
    fields: [
      ...
      { label: 'SEO Knowledge:', name: 'contentSeoKnowledge', type: 'text', placeholder: 'e.g., Basic, Intermediate, Advanced', required: true },
    ],
  },
  'SOCIAL MEDIA': {
    title: 'SOCIAL MEDIA',
...
• Controlling: Monitoring progress, evaluating results, and making adjustments.`,
    fields: [
      ...
      { label: 'Project Management Tools:', name: 'managementProjectTools', type: 'text', placeholder: 'e.g., Asana, Trello, Jira', required: true },
...
• Solve design problems creatively and effectively.`,
    fields: [
      ...
      { label: 'UX/UI Experience:', name: 'designUxUiExperience', type: 'textarea', placeholder: 'Describe your experience with user experience and interface design.', required: true },
    ],
  },
  'PR': {
    title: 'PR',
...
• Customer engagement: Building trust and loyalty with the audience.`,
    fields: [
      ...
      { label: 'Preferred Marketing Tools:', name: 'marketingPreferredTools', type: 'text', placeholder: 'e.g., Google Analytics, Mailchimp, CRM software', required: true },
